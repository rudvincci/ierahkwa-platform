...
// using Mamey.ApplicationName.Bootstrapper;
...
// namespace Mamey.ApplicationName.MicroMonolith.Tests.EndToEnd;
...
//         var authManager = new AuthManager(options => { 
            
//         })
//         var jwt = AuthManager. AuthHelper.GenerateJwt(userId, claims: claims);
