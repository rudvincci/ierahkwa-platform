...
```mermaid
flowchart TD
    COMPANY[Company Information<br/>Corporate Structure<br/>Financial Info<br/>Legal & Compliance]
    TECH[Technology<br/>Code & Architecture<br/>Platform Status<br/>Performance Validation]
    MARKET[Market<br/>Market Analysis<br/>Competitive Analysis<br/>Customer Validation]
    BUSINESS[Business Model<br/>Revenue Model<br/>Go-to-Market<br/>Financial Projections]
    TEAM[Team<br/>Leadership<br/>Development<br/>Advisory & Board]
    RISK[Risk Assessment<br/>Technical Risks<br/>Market Risks<br/>Business Risks]
    
    COMPANY --> DECISION[Due Diligence<br/>Decision]
    TECH --> DECISION
    MARKET --> DECISION
    BUSINESS --> DECISION
    TEAM --> DECISION
    ...
    style DECISION fill:#27ae60,stroke:#229954,color:#fff
```
