namespace Mamey.MessageBrokers.RabbitMQ.Publishers;
...
internal sealed class RabbitMqPublisher : IBusPublisher
{
    ...
    public Task PublishAsync<T>(T message, string messageId = null, string correlationId = null,
        ...
        where T : class
    {
        _client.SendAsync(message, _conventionsProvider.Get(message.GetType()), messageId, correlationId, spanContext,
