...
using Mamey.MessageBrokers.RabbitMQ.Clients;
using Mamey.MessageBrokers.RabbitMQ.Contexts;
using Mamey.MessageBrokers.RabbitMQ.Conventions;
using Mamey.MessageBrokers.RabbitMQ.Initializers;
using Mamey.MessageBrokers.RabbitMQ.Internals;
using Mamey.MessageBrokers.RabbitMQ.Plugins;
using Mamey.MessageBrokers.RabbitMQ.Publishers;
using Mamey.MessageBrokers.RabbitMQ.Serializers;
...
public static class Extensions
{
    ...
    public static IMameyBuilder AddRabbitMq(this IMameyBuilder builder, string sectionName = SectionName,
