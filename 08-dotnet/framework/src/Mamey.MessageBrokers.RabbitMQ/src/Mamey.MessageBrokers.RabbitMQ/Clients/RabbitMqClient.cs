...
namespace Mamey.MessageBrokers.RabbitMQ.Clients;
...
internal sealed class RabbitMqClient : IRabbitMqClient
{
    ...
    public async Task SendAsync(object message, IConventions conventions, string messageId = null, string correlationId = null,
        string spanContext = null, object messageContext = null, IDictionary<string, object> headers = null)
    {
        ...
        await channel.BasicPublishAsync(conventions.Exchange, conventions.RoutingKey, false, properties, body.ToArray());
    }
