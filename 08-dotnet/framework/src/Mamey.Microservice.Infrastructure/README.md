...
- [Mamey.Microservice.Abstractions](Microservice.Abstractions/README.md) - Microservice abstractions
...
- [Mamey.Persistence.MongoDB](Persistence.MongoDB/README.md) - MongoDB persistence
- [Mamey.Tracing.Jaeger](Tracing.Jaeger/README.md) - Jaeger tracing integration

## Additional Resources

- [Microservice Architecture Guide](../guides/microservice-architecture.md)
- [Authentication Guide](../guides/authentication.md)
- [Distributed Tracing Guide](../guides/distributed-tracing.md)
