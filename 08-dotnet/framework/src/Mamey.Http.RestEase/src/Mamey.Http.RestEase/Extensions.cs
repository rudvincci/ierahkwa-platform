...
using Mamey.Http.RestEase.Builders;
using Mamey.Http.RestEase.Serializers;
...
public static class Extensions
{
    ...
    public static IMameyBuilder AddServiceClient<T>(this IMameyBuilder builder, string serviceName,
    ...
    private static IMameyBuilder AddServiceClient<T>(this IMameyBuilder builder, string serviceName, 
        RestEaseOptions options, Action<IMameyBuilder> registerFabio)
        where T : class
    {
