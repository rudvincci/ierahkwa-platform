...
using Mamey.MessageBrokers.CQRS.Dispatchers;
...
public static class Extensions
{
    ...
    public static IMameyBuilder AddServiceBusCommandDispatcher(this IMameyBuilder builder)
    {
        builder.Services.AddTransient<ICommandDispatcher, ServiceBusMessageDispatcher>();
        return builder;
    }

    public static IMameyBuilder AddServiceBusEventDispatcher(this IMameyBuilder builder)
    {
