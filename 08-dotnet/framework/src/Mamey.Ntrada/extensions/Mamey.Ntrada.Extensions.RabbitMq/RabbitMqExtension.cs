...
using Mamey.Ntrada.Extensions.RabbitMq.Clients;
using Mamey.Ntrada.Extensions.RabbitMq.Contexts;
using Mamey.Ntrada.Extensions.RabbitMq.Handlers;
        ...
        public void Add(IServiceCollection services, IOptionsProvider optionsProvider)
        {
            ...
            services.AddSingleton(sp =>
            {
                var connectionFactory = new ConnectionFactory
                {
                    ...
                    RequestedHeartbeat = TimeSpan.FromMilliseconds(options.RequestedHeartbeat),
