...
using Mamey.Ntrada.Auth;
using Mamey.Ntrada.Configuration;
using Mamey.Ntrada.Extensions;
using Mamey.Ntrada.Handlers;
using Mamey.Ntrada.Options;
using Mamey.Ntrada.Requests;
using Mamey.Ntrada.Routing;
using Mamey.Ntrada.WebApi;
using Polly;

[assembly: InternalsVisibleTo("Mamey.Ntrada.Tests.Unit")]
...
https://github.com/snatch-dev/Mamey.Ntrada
";
