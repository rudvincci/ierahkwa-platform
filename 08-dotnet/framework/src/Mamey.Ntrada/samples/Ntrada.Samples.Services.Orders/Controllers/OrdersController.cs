...
using Mamey.Ntrada.Samples.Services.Orders.Models;
using Mamey.Ntrada.Samples.Services.Orders.Requests;
using Mamey.Ntrada.Samples.Services.Orders.Services;

namespace Mamey.Ntrada.Samples.Services.Orders.Controllers
{
    [ApiController]
    [Route("[controller]")]
