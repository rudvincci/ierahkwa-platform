...
/// <summary>
/// Client for WalletService operations
/// </summary>
public class MameyWalletClient : IDisposable
{
    private readonly WalletService.WalletServiceClient _client;
    private readonly GrpcChannel _channel;
    private readonly ILogger<MameyWalletClient>? _logger;
    private bool _disposed;

    /// <summary>
    /// Initializes a new instance of the MameyWalletClient
    /// </summary>
    public MameyWalletClient(IOptions<MameyWalletClientOptions> options, ILogger<MameyWalletClient>? logger = null)
    {
        ...
        _client = new WalletService.WalletServiceClient(_channel);
        
        _logger?.LogInformation("Initialized {Client} connecting to {Url}", nameof(MameyWalletClient), opts.NodeUrl);
    }
    ...
    /// </summary>
    public WalletService.WalletServiceClient Client => _client;
