...
namespace Mamey.MessageBrokers.Outbox.EntityFramework.Internals;
...
internal sealed class EntityFrameworkMessageOutbox<TContext, TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken>
    : IMessageOutbox, IMessageOutboxAccessor
        ...
        where TUserToken : IdentityUserToken<TKey>
{
    ...
    private const string EmptyJsonObject = "{}";
    private readonly TContext _dbContext;
    private readonly ILogger<EntityFrameworkMessageOutbox<TContext, TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken>> _logger;
    private readonly DbSet<InboxMessage> _inboxMessagesSet;

    public bool Enabled { get; }

    public EntityFrameworkMessageOutbox(TContext dbContext, OutboxOptions options,
        ILogger<EntityFrameworkMessageOutbox<TContext, TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken>> logger)
    {
        _dbContext = dbContext;
        _logger = logger;
        _inboxMessagesSet = _dbContext.Set<InboxMessage>();
