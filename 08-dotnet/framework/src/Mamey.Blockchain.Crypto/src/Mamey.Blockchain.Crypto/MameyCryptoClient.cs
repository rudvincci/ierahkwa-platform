...
/// <summary>
/// Client for CryptoService operations
/// </summary>
public class MameyCryptoClient : IDisposable
{
    private readonly CryptoService.CryptoServiceClient _client;
    private readonly GrpcChannel _channel;
    private readonly ILogger<MameyCryptoClient>? _logger;
    private bool _disposed;

    /// <summary>
    /// Initializes a new instance of the MameyCryptoClient
    /// </summary>
    public MameyCryptoClient(IOptions<MameyCryptoClientOptions> options, ILogger<MameyCryptoClient>? logger = null)
    {
        ...
        _logger?.LogInformation("Initialized {Client} connecting to {Url}", nameof(MameyCryptoClient), opts.NodeUrl);
    }
    ...
    /// </summary>
    public CryptoService.CryptoServiceClient Client => _client;
