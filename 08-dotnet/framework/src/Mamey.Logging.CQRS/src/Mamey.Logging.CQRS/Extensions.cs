...
using Mamey.Logging.CQRS.Decorators;
...
{
    public static IMameyBuilder AddCommandHandlersLogging(this IMameyBuilder builder, Assembly assembly = null)
        => builder.AddHandlerLogging(typeof(ICommandHandler<>), typeof(CommandHandlerLoggingDecorator<>), assembly);

    public static IMameyBuilder AddEventHandlersLogging(this IMameyBuilder builder, Assembly assembly = null)
        => builder.AddHandlerLogging(typeof(IEventHandler<>), typeof(EventHandlerLoggingDecorator<>), assembly);

    private static IMameyBuilder AddHandlerLogging(this IMameyBuilder builder, Type handlerType,
