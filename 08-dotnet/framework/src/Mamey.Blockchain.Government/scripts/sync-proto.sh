...
SDK_PROTO_DIR="$SCRIPT_DIR/../src/Mamey.Blockchain.Government/Protos"
...
# Sync government.proto
if [ -f "$MANEYNODE_PROTO_DIR/government.proto" ]; then
    echo "Syncing government.proto..."
    cp "$MANEYNODE_PROTO_DIR/government.proto" "$SDK_PROTO_DIR/government.proto"
    echo "✓ government.proto synced"
else
    echo "Warning: government.proto not found in MameyNode"
fi
