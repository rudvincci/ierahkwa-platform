...
SDK_PROTO_DIR="$SCRIPT_DIR/../src/Mamey.Blockchain.UniversalProtocolGateway/Protos"
...
# Sync upg.proto
if [ -f "$MANEYNODE_PROTO_DIR/upg.proto" ]; then
    echo "Syncing upg.proto..."
    cp "$MANEYNODE_PROTO_DIR/upg.proto" "$SDK_PROTO_DIR/upg.proto"
    echo "✓ upg.proto synced"
else
    echo "Warning: upg.proto not found in MameyNode"
fi
