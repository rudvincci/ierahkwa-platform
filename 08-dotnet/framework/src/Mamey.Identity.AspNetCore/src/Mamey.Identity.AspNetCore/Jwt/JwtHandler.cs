...
using Mamey.Identity.AspNetCore.Configuration;
...
{
    private static readonly IDictionary<string, string> EmptyClaims =
    ...
    public JwtHandler(AuthOptions options, TokenValidationParameters tokenValidationParameters)
    {
