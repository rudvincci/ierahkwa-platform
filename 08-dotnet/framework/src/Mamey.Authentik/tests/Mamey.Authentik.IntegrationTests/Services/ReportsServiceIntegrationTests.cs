...
public class ReportsServiceIntegrationTests : IClassFixture<AuthentikTestFixture>
{
    private readonly AuthentikTestFixture _fixture;
    private readonly IAuthentikClient? _client;

    public ReportsServiceIntegrationTests(AuthentikTestFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task HealthCheck_ServiceIsAccessible()
    {
        ...
        _client.Reports.Should().NotBeNull();
    }
