...
public class StagesServiceIntegrationTests : IClassFixture<AuthentikTestFixture>
{
    private readonly AuthentikTestFixture _fixture;
    private readonly IAuthentikClient? _client;

    public StagesServiceIntegrationTests(AuthentikTestFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task HealthCheck_ServiceIsAccessible()
    {
        ...
        _client.Stages.Should().NotBeNull();
    }
    ...
    public async Task Service_WithInvalidToken_ThrowsAuthenticationException()
    {
        ...
        client.Stages.Should().NotBeNull();
    }
