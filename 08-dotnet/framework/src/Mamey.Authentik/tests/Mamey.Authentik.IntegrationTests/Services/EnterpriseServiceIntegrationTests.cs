...
public class EnterpriseServiceIntegrationTests : IClassFixture<AuthentikTestFixture>
{
    private readonly AuthentikTestFixture _fixture;
    private readonly IAuthentikClient? _client;

    public EnterpriseServiceIntegrationTests(AuthentikTestFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task HealthCheck_ServiceIsAccessible()
    {
        ...
        _client.Enterprise.Should().NotBeNull();
    }
    ...
    public async Task Service_WithInvalidToken_ThrowsAuthenticationException()
    {
        ...
        client.Enterprise.Should().NotBeNull();
    }

    // TODO: Add actual API method tests after code generation
    // Note: Enterprise features may require a license
}
