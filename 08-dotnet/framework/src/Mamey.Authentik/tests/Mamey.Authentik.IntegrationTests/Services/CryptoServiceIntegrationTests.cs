...
public class CryptoServiceIntegrationTests : IClassFixture<AuthentikTestFixture>
{
    private readonly AuthentikTestFixture _fixture;
    private readonly IAuthentikClient? _client;

    public CryptoServiceIntegrationTests(AuthentikTestFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task HealthCheck_ServiceIsAccessible()
    {
        ...
        _client.Crypto.Should().NotBeNull();
    }
    ...
    public async Task Service_WithInvalidToken_ThrowsAuthenticationException()
    {
        ...
        client.Crypto.Should().NotBeNull();
    }
