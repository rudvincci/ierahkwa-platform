...
public class RacServiceIntegrationTests : IClassFixture<AuthentikTestFixture>
{
    private readonly AuthentikTestFixture _fixture;
    private readonly IAuthentikClient? _client;

    public RacServiceIntegrationTests(AuthentikTestFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task Service_WithInvalidToken_ThrowsAuthenticationException()
    {
        ...
        client.Rac.Should().NotBeNull();
    }

    // TODO: Add actual API method tests after code generation:
    // - GetEndpointsAsync (Remote Access Control)
    // - CreateEndpointAsync
    // - UpdateEndpointAsync
    // - DeleteEndpointAsync
    // - etc.
