...
public class RootServiceIntegrationTests : IClassFixture<AuthentikTestFixture>
{
    private readonly AuthentikTestFixture _fixture;
    private readonly IAuthentikClient? _client;

    public RootServiceIntegrationTests(AuthentikTestFixture fixture)
    {
        _fixture = fixture;
