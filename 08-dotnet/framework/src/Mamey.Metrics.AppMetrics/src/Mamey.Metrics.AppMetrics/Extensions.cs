...
using Mamey.Metrics.AppMetrics.Builders;
using Mamey.Types;
...
namespace Mamey.Metrics.AppMetrics;
...
public static class Extensions
{
    ...
    public static IMameyBuilder AddMetrics(this IMameyBuilder builder,
    ...
    public static IMameyBuilder AddMetrics(this IMameyBuilder builder, MetricsOptions metricsOptions,
