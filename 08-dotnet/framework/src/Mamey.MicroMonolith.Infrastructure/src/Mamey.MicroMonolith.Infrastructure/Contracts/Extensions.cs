...
namespace Mamey.MicroMonolith.Infrastructure.Contracts;
...
public static class Extensions
{
    ...
    public static WebApplication ValidateContracts(this WebApplication app, IEnumerable<Assembly> assemblies)
    {
        var contractRegistry = app.Services.GetRequiredService<IContractRegistry>();
        contractRegistry.Validate(assemblies);
