...
//using Mamey.MicroMonolith.Abstractions.Commands;
//using Mamey.MicroMonolith.Abstractions.Events;
//using Mamey.MicroMonolith.Abstractions.Queries;
//using Mamey.MicroMonolith.Infrastructure.Postgres.Decorators;

//namespace Mamey.MicroMonolith.Infrastructure.SqlServer;
...
//            providerOptions => {
//                if(options.RetryOnFailureEnabled)
//                {
