using Mamey.Discovery.Consul.Builders;
using Mamey.Discovery.Consul.Http;
using Mamey.Discovery.Consul.MessageHandlers;
using Mamey.Discovery.Consul.Models;
using Mamey.Discovery.Consul.Services;
using Mamey.Http;
...
public static class Extensions
{
    ...
    public static IMameyBuilder AddConsul(this IMameyBuilder builder, string sectionName = SectionName,
    ...
    public static IMameyBuilder AddConsul(this IMameyBuilder builder,
    ...
    public static IMameyBuilder AddConsul(this IMameyBuilder builder, ConsulOptions options,
    ...
    public static void AddConsulHttpClient(this IMameyBuilder builder, string clientName, string serviceName)
    ...
    private static ServiceRegistration CreateConsulAgentRegistration(this IMameyBuilder builder,
