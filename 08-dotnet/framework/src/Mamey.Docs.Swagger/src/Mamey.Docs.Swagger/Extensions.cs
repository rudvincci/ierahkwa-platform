using Mamey.Docs.Swagger.Builders;
...
public static class Extensions
{
    ...
    public static IMameyBuilder AddSwaggerDocs(this IMameyBuilder builder, string sectionName = SectionName)
    {
    ...
    public static IMameyBuilder AddSwaggerDocs(this IMameyBuilder builder,
    ...
    public static IMameyBuilder AddSwaggerDocs(this IMameyBuilder builder, SwaggerOptions options)
    {
