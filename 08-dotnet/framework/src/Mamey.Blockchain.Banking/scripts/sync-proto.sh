...
SDK_PROTO_DIR="$SCRIPT_DIR/../src/Mamey.Blockchain.Banking/Protos"
...
# Sync banking.proto
if [ -f "$MANEYNODE_PROTO_DIR/banking.proto" ]; then
    echo "Syncing banking.proto..."
    cp "$MANEYNODE_PROTO_DIR/banking.proto" "$SDK_PROTO_DIR/banking.proto"
    echo "✓ banking.proto synced"
else
    echo "Warning: banking.proto not found in MameyNode"
fi
