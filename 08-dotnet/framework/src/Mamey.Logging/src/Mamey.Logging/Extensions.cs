...
using FileOptions = Mamey.Logging.Options.FileOptions;

namespace Mamey.Logging;
        ...
        bool writeToProviders = false)
    {
        ...
        builder.ConfigureServices((context, services) =>
        {
            services.AddSerilog(
                ...
                {
                    // Adaptation: get WebHostBuilderContext from IServiceProvider if needed
                    if (context is WebHostBuilderContext whbContext)
                    {
                        configureLogger(whbContext, loggerConfiguration);
                    }
                    else
                    {
                        // Fallback for older patterns
                        configureLogger(null, loggerConfiguration);
                    }
                },
