[![nuget](https://img.shields.io/nuget/v/Mamey.OpenTracingContrib.svg?logo=nuget)](https://www.nuget.org/packages/Mamey.OpenTracingContrib)
...
##### 1. Add the NuGet package `Mamey.OpenTracingContrib` to your project.
