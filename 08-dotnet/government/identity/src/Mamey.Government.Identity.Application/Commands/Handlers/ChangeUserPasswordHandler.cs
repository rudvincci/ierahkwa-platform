...
internal sealed class ChangeUserPasswordHandler : ICommandHandler<ChangeUserPassword>
{
    ...
    public ChangeUserPasswordHandler(IUserRepository userRepository, IEventProcessor eventProcessor)
    {
        _userRepository = userRepository;
        _eventProcessor = eventProcessor;
    }

    public async Task HandleAsync(ChangeUserPassword command, CancellationToken cancellationToken = default)
    {
