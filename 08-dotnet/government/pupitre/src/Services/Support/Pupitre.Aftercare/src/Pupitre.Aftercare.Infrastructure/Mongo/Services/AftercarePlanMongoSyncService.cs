...
using Pupitre.Aftercare.Infrastructure.Mongo.Options;
using Pupitre.Aftercare.Infrastructure.Mongo.Repositories;

namespace Pupitre.Aftercare.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class AftercarePlanMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AftercarePlanMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public AftercarePlanMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<AftercarePlanMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<AftercarePlanMongoRepository>();
