...
namespace Pupitre.Educators.Infrastructure.EF.Configuration;
...
public class EducatorConfiguration : IEntityTypeConfiguration<Educator>
{
    ...
    void IEntityTypeConfiguration<Educator>.Configure(EntityTypeBuilder<Educator> builder)
    {
        ...
        .HasConversion(c=> c.Value, c=> new EducatorId(c))
        .IsRequired();
