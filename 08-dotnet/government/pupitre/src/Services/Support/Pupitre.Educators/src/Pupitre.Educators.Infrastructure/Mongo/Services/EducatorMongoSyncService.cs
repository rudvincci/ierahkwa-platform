...
using Pupitre.Educators.Infrastructure.Mongo.Options;
using Pupitre.Educators.Infrastructure.Mongo.Repositories;

namespace Pupitre.Educators.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class EducatorMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<EducatorMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public EducatorMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<EducatorMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<EducatorMongoRepository>();
