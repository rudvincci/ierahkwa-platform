...
internal class CompositeEducatorRepository : IEducatorRepository
{
    private readonly EducatorPostgresRepository _postgresRepo;
    private readonly EducatorMongoRepository _mongoRepo;
    private readonly EducatorRedisRepository _redisRepo;
    private readonly ILogger<CompositeEducatorRepository> _logger;

    public CompositeEducatorRepository(
        EducatorPostgresRepository postgresRepo,
        EducatorMongoRepository mongoRepo,
        EducatorRedisRepository redisRepo,
        ILogger<CompositeEducatorRepository> logger)
    {
