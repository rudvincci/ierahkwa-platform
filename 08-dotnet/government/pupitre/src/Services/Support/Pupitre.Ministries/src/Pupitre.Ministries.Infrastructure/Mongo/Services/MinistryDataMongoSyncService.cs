...
using Pupitre.Ministries.Infrastructure.Mongo.Options;
using Pupitre.Ministries.Infrastructure.Mongo.Repositories;

namespace Pupitre.Ministries.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class MinistryDataMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<MinistryDataMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public MinistryDataMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<MinistryDataMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<MinistryDataMongoRepository>();
