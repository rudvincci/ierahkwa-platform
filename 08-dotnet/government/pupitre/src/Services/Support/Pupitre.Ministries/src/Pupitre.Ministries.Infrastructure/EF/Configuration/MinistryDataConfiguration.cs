...
namespace Pupitre.Ministries.Infrastructure.EF.Configuration;

public class MinistryDataConfiguration : IEntityTypeConfiguration<MinistryData>
{
    public MinistryDataConfiguration()
    {
    }

    void IEntityTypeConfiguration<MinistryData>.Configure(EntityTypeBuilder<MinistryData> builder)
    {
        builder.ToTable("ministrydata");
        ...
        .HasConversion(c=> c.Value, c=> new MinistryDataId(c))
        .IsRequired();
