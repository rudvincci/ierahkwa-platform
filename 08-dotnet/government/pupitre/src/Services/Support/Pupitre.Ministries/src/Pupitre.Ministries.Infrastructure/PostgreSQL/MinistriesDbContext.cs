...
namespace Pupitre.Ministries.Infrastructure.PostgreSQL;

internal class MinistriesDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<MinistryData> MinistryDatas { get; set; }

    public MinistriesDbContext(DbContextOptions<MinistriesDbContext> options) : base(options)
    {
    }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("ministries");
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(MinistriesDbContext).Assembly);
