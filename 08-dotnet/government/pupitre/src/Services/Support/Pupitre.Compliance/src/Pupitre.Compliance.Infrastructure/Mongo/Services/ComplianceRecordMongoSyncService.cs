...
using Pupitre.Compliance.Infrastructure.Mongo.Options;
using Pupitre.Compliance.Infrastructure.Mongo.Repositories;

namespace Pupitre.Compliance.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class ComplianceRecordMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<ComplianceRecordMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public ComplianceRecordMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<ComplianceRecordMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<ComplianceRecordMongoRepository>();
