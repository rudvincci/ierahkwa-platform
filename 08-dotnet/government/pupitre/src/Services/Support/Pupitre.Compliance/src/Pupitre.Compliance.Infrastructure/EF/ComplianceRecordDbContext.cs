...
internal class ComplianceRecordDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<ComplianceRecord> ComplianceRecords { get; set; }

    public ComplianceRecordDbContext(DbContextOptions<ComplianceRecordDbContext> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(ComplianceRecordDbContext).Assembly);
