...
namespace Pupitre.Accessibility.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/accessibility")] = Query(typeof(GetAccessProfile).Name),
            [GetKey("POST", "/accessibility")] = Command(typeof(AddAccessProfile).Name),
            [GetKey("PUT", "/accessibility")] = Command(typeof(UpdateAccessProfile).Name),
            [GetKey("DELETE", "/accessibility")] = Command(typeof(DeleteAccessProfile).Name)
        };
