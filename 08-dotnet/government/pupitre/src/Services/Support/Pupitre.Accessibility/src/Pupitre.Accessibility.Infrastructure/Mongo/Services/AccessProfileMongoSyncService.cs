...
using Pupitre.Accessibility.Infrastructure.Mongo.Options;
using Pupitre.Accessibility.Infrastructure.Mongo.Repositories;

namespace Pupitre.Accessibility.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class AccessProfileMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AccessProfileMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public AccessProfileMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<AccessProfileMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<AccessProfileMongoRepository>();
