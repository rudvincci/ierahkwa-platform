...
internal class CompositeCampaignRepository : ICampaignRepository
{
    private readonly CampaignPostgresRepository _postgresRepo;
    private readonly CampaignMongoRepository _mongoRepo;
    private readonly CampaignRedisRepository _redisRepo;
    private readonly ILogger<CompositeCampaignRepository> _logger;

    public CompositeCampaignRepository(
        CampaignPostgresRepository postgresRepo,
        CampaignMongoRepository mongoRepo,
        CampaignRedisRepository redisRepo,
        ILogger<CompositeCampaignRepository> logger)
    {
