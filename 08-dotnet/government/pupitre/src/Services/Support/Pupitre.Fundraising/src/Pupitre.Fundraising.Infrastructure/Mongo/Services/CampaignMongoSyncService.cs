...
using Pupitre.Fundraising.Infrastructure.Mongo.Options;
using Pupitre.Fundraising.Infrastructure.Mongo.Repositories;

namespace Pupitre.Fundraising.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class CampaignMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<CampaignMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public CampaignMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<CampaignMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<CampaignMongoRepository>();
