...
using Pupitre.Bookstore.Infrastructure.Redis.Options;
using Pupitre.Bookstore.Infrastructure.Redis.Repositories;

namespace Pupitre.Bookstore.Infrastructure.Redis.Services;

internal class BookRedisSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<BookRedisSyncService> _logger;
    private readonly RedisSyncOptions _options;

    public BookRedisSyncService(
        IServiceProvider serviceProvider,
        ILogger<BookRedisSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var redisRepo = scope.ServiceProvider.GetRequiredService<BookRedisRepository>();
