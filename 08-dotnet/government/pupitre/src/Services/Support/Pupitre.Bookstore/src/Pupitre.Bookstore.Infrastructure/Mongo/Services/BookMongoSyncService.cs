...
using Pupitre.Bookstore.Infrastructure.Mongo.Options;
using Pupitre.Bookstore.Infrastructure.Mongo.Repositories;

namespace Pupitre.Bookstore.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class BookMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<BookMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public BookMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<BookMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var postgresRepo = scope.ServiceProvider.GetRequiredService<BookPostgresRepository>();
        var mongoRepo = scope.ServiceProvider.GetRequiredService<BookMongoRepository>();
