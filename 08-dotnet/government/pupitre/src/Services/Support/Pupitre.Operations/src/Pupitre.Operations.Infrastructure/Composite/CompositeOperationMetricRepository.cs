...
internal class CompositeOperationMetricRepository : IOperationMetricRepository
{
    private readonly OperationMetricPostgresRepository _postgresRepo;
    private readonly OperationMetricMongoRepository _mongoRepo;
    private readonly OperationMetricRedisRepository _redisRepo;
    private readonly ILogger<CompositeOperationMetricRepository> _logger;

    public CompositeOperationMetricRepository(
        OperationMetricPostgresRepository postgresRepo,
        OperationMetricMongoRepository mongoRepo,
        OperationMetricRedisRepository redisRepo,
        ILogger<CompositeOperationMetricRepository> logger)
    {
