...
using Pupitre.Analytics.Infrastructure.Mongo.Options;
using Pupitre.Analytics.Infrastructure.Mongo.Repositories;

namespace Pupitre.Analytics.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class AnalyticMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AnalyticMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public AnalyticMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<AnalyticMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<AnalyticMongoRepository>();
