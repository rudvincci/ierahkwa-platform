...
using Pupitre.Analytics.Infrastructure.Redis.Options;
using Pupitre.Analytics.Infrastructure.Redis.Repositories;

namespace Pupitre.Analytics.Infrastructure.Redis.Services;

internal class AnalyticRedisSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AnalyticRedisSyncService> _logger;
    private readonly RedisSyncOptions _options;

    public AnalyticRedisSyncService(
        IServiceProvider serviceProvider,
        ILogger<AnalyticRedisSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var postgresRepo = scope.ServiceProvider.GetRequiredService<AnalyticPostgresRepository>();
        var redisRepo = scope.ServiceProvider.GetRequiredService<AnalyticRedisRepository>();
