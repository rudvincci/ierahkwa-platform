...
namespace Pupitre.Assessments.Infrastructure.EF.Configuration;
...
public class AssessmentConfiguration : IEntityTypeConfiguration<Assessment>
{
    ...
    void IEntityTypeConfiguration<Assessment>.Configure(EntityTypeBuilder<Assessment> builder)
    {
        ...
        .HasConversion(c=> c.Value, c=> new AssessmentId(c))
        .IsRequired();
