...
[assembly: InternalsVisibleTo("Pupitre.Assessments.Tests.Unit.Core.Entities")]
namespace Pupitre.Assessments.Domain.Entities;


internal class Assessment : AggregateRoot<AssessmentId>
{
    #region Fields
    ...
    public Assessment(AssessmentId id, string name, DateTime createdAt,
    ...
    /// </summary>
    [Description("The assessment's name")]
    ...
    /// <summary>
    /// Collection of Assessment tags.
    /// </summary>
    [Description("Collection of Assessment tags.")]
    ...
    public static Assessment Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingAssessmentNameException();
        }

        var assessment = new Assessment(id, name, DateTime.UtcNow, tags: tags,
        ...
        assessment.SetBlockchainMetadata(metadata);
        assessment.AddEvent(new AssessmentCreated(assessment));
        return assessment;
    }
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new AssessmentModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new AssessmentBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidAssessmentTagsException();
        }
    }
}
