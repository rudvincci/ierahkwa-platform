...
using Pupitre.Curricula.Infrastructure.Mongo.Options;
using Pupitre.Curricula.Infrastructure.Mongo.Repositories;

namespace Pupitre.Curricula.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class CurriculumMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<CurriculumMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public CurriculumMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<CurriculumMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<CurriculumMongoRepository>();
