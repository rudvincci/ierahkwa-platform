...
[assembly: InternalsVisibleTo("Pupitre.Curricula.Tests.Unit.Core.Entities")]
namespace Pupitre.Curricula.Domain.Entities;


internal class Curriculum : AggregateRoot<CurriculumId>
{
    #region Fields
    ...
    public Curriculum(CurriculumId id, string name, DateTime createdAt,
        DateTime? modifiedAt = null, IEnumerable<string>? tags = null, string? citizenId = null,
        string? nationality = null, string? programCode = null, string? credentialType = null,
        DateTime? completionDate = null, string? blockchainMetadata = null,
        string? governmentIdentityId = null, string? blockchainAccount = null,
        string? credentialDocumentId = null, string? credentialDocumentHash = null,
        string? ledgerTransactionId = null, DateTime? credentialIssuedAt = null,
        string? credentialStatus = null, int version = 0)
        : base(id, version)
    {
        Name = name;
        CreatedAt = createdAt;
    ...
    /// <summary>
    /// A name for the curriculum.
    /// </summary>
    [Description("The curriculum's name")]
    ...
    /// <summary>
    /// Collection of Curriculum tags.
    /// </summary>
    [Description("Collection of Curriculum tags.")]
    ...
    public static Curriculum Create(Guid id, string name, IEnumerable<string>? tags,
        ...
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingCurriculumNameException();
        }

        var curriculum = new Curriculum(id, name, DateTime.UtcNow, tags: tags,
        ...
        curriculum.SetBlockchainMetadata(metadata);
        curriculum.AddEvent(new CurriculumCreated(curriculum));
        return curriculum;
    }
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new CurriculumModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new CurriculumBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidCurriculumTagsException();
        }
    }
}
