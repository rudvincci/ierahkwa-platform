...
using Pupitre.Progress.Infrastructure.Mongo.Options;
using Pupitre.Progress.Infrastructure.Mongo.Repositories;

namespace Pupitre.Progress.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class LearningProgressMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<LearningProgressMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public LearningProgressMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<LearningProgressMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<LearningProgressMongoRepository>();
