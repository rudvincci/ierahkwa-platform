...
namespace Pupitre.Progress.Infrastructure.EF.Configuration;

public class LearningProgressConfiguration : IEntityTypeConfiguration<LearningProgress>
{
    public LearningProgressConfiguration()
    {
    }

    void IEntityTypeConfiguration<LearningProgress>.Configure(EntityTypeBuilder<LearningProgress> builder)
    {
        ...
        .HasConversion(c=> c.Value, c=> new LearningProgressId(c))
        .IsRequired();
