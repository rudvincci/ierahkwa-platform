...
[assembly: InternalsVisibleTo("Pupitre.Progress.Tests.Unit.Core.Entities")]
namespace Pupitre.Progress.Domain.Entities;


internal class LearningProgress : AggregateRoot<LearningProgressId>
{
    #region Fields
    ...
    public LearningProgress(LearningProgressId id, string name, DateTime createdAt,
    ...
    /// <summary>
    /// A name for the learningprogress.
    /// </summary>
    [Description("The learningprogress's name")]
    ...
    /// <summary>
    /// Collection of LearningProgress tags.
    /// </summary>
    [Description("Collection of LearningProgress tags.")]
    ...
    public static LearningProgress Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingLearningProgressNameException();
        }

        var learningprogress = new LearningProgress(id, name, DateTime.UtcNow, tags: tags,
        ...
        learningprogress.SetBlockchainMetadata(metadata);
        learningprogress.AddEvent(new LearningProgressCreated(learningprogress));
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new LearningProgressModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new LearningProgressBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidLearningProgressTagsException();
        }
    }
}
