...
internal class CompositeLessonRepository : ILessonRepository
{
    private readonly LessonPostgresRepository _postgresRepo;
    private readonly LessonMongoRepository _mongoRepo;
    private readonly LessonRedisRepository _redisRepo;
    private readonly ILogger<CompositeLessonRepository> _logger;

    public CompositeLessonRepository(
        LessonPostgresRepository postgresRepo,
        LessonMongoRepository mongoRepo,
        LessonRedisRepository redisRepo,
        ILogger<CompositeLessonRepository> logger)
    {
