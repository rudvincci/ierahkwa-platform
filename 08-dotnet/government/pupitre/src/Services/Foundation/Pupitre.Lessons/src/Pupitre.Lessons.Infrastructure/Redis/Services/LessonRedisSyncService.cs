...
using Pupitre.Lessons.Infrastructure.Redis.Options;
using Pupitre.Lessons.Infrastructure.Redis.Repositories;

namespace Pupitre.Lessons.Infrastructure.Redis.Services;

internal class LessonRedisSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<LessonRedisSyncService> _logger;
    private readonly RedisSyncOptions _options;

    public LessonRedisSyncService(
        IServiceProvider serviceProvider,
        ILogger<LessonRedisSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var redisRepo = scope.ServiceProvider.GetRequiredService<LessonRedisRepository>();
