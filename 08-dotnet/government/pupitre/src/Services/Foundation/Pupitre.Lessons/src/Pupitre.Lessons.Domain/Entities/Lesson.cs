...
[assembly: InternalsVisibleTo("Pupitre.Lessons.Tests.Unit.Core.Entities")]
namespace Pupitre.Lessons.Domain.Entities;


internal class Lesson : AggregateRoot<LessonId>
{
    #region Fields
    ...
    public Lesson(LessonId id, string name, DateTime createdAt,
    ...
    /// </summary>
    [Description("Collection of Lesson tags.")]
    ...
    public static Lesson Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingLessonNameException();
        }

        var lesson = new Lesson(id, name, DateTime.UtcNow, tags: tags,
        ...
        lesson.SetBlockchainMetadata(metadata);
        lesson.AddEvent(new LessonCreated(lesson));
        return lesson;
    }
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new LessonModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new LessonBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidLessonTagsException();
        }
    }
}
