...
using Pupitre.Users.Infrastructure.Mongo.Options;
using Pupitre.Users.Infrastructure.Mongo.Repositories;

namespace Pupitre.Users.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class UserMongoSyncService : BackgroundService
{
