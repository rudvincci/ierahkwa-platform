...
[assembly: InternalsVisibleTo("Pupitre.Users.Tests.Unit.Core.Entities")]
...
internal class User : AggregateRoot<UserId>
{
    ...
    public User(UserId id, string name, DateTime createdAt,
    ...
    /// </summary>
    [Description("Collection of User tags.")]
    ...
    public static User Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        var user = new User(id, name, DateTime.UtcNow, tags: tags,
        ...
        user.SetBlockchainMetadata(metadata);
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new UserModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new UserBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidUserTagsException();
        }
    }
}
