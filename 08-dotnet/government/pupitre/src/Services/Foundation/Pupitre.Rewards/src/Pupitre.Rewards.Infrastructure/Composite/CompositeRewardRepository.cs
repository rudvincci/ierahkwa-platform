...
internal class CompositeRewardRepository : IRewardRepository
{
    private readonly RewardPostgresRepository _postgresRepo;
    private readonly RewardMongoRepository _mongoRepo;
    private readonly RewardRedisRepository _redisRepo;
    private readonly ILogger<CompositeRewardRepository> _logger;

    public CompositeRewardRepository(
        RewardPostgresRepository postgresRepo,
        RewardMongoRepository mongoRepo,
        RewardRedisRepository redisRepo,
        ILogger<CompositeRewardRepository> logger)
    {
