...
namespace Pupitre.Rewards.Application.DTO;

internal class RewardDetailsDto : RewardDto
{
    ...
    public RewardDetailsDto(
        ...
        string? credentialDocumentId = null,
        string? ledgerTransactionId = null)
        : base(rewardDto.Id, rewardDto.Name, rewardDto.Tags,
            rewardDto.ProgramCode, rewardDto.CredentialType, rewardDto.CitizenId,
            rewardDto.GovernmentIdentityId, rewardDto.BlockchainAccount, rewardDto.CredentialStatus,
            rewardDto.Nationality, rewardDto.BlockchainMetadata)
    {
        CreatedAt = createdAt;
        ModifiedAt = modifiedAt;
        CompletionDate = completionDate;
