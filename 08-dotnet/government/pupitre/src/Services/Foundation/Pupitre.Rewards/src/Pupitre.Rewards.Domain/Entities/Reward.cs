...
[assembly: InternalsVisibleTo("Pupitre.Rewards.Tests.Unit.Core.Entities")]
namespace Pupitre.Rewards.Domain.Entities;


internal class Reward : AggregateRoot<RewardId>
{
    #region Fields
    ...
    public Reward(RewardId id, string name, DateTime createdAt,
    ...
    /// <summary>
    /// Collection of Reward tags.
    /// </summary>
    [Description("Collection of Reward tags.")]
    ...
    public static Reward Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingRewardNameException();
        }

        var reward = new Reward(id, name, DateTime.UtcNow, tags: tags,
        ...
        reward.SetBlockchainMetadata(metadata);
        reward.AddEvent(new RewardCreated(reward));
        return reward;
    }
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new RewardModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new RewardBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidRewardTagsException();
        }
    }
}
