...
namespace Pupitre.Rewards.Infrastructure.EF.Configuration;
...
public class RewardConfiguration : IEntityTypeConfiguration<Reward>
{
    ...
    void IEntityTypeConfiguration<Reward>.Configure(EntityTypeBuilder<Reward> builder)
    {
        ...
        .HasConversion(c=> c.Value, c=> new RewardId(c))
        .IsRequired();
