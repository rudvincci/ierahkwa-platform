...
using Pupitre.Rewards.Infrastructure.Mongo.Options;
using Pupitre.Rewards.Infrastructure.Mongo.Repositories;

namespace Pupitre.Rewards.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class RewardMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<RewardMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public RewardMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<RewardMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<RewardMongoRepository>();
