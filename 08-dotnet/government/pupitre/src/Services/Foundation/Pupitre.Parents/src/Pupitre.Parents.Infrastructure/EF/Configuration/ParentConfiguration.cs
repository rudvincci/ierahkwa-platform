...
namespace Pupitre.Parents.Infrastructure.EF.Configuration;
...
public class ParentConfiguration : IEntityTypeConfiguration<Parent>
{
    ...
    void IEntityTypeConfiguration<Parent>.Configure(EntityTypeBuilder<Parent> builder)
    {
        ...
        .HasConversion(c=> c.Value, c=> new ParentId(c))
        .IsRequired();
