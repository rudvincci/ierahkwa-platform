...
[assembly: InternalsVisibleTo("Pupitre.Parents.Tests.Unit.Core.Entities")]
namespace Pupitre.Parents.Domain.Entities;


internal class Parent : AggregateRoot<ParentId>
{
    #region Fields
    ...
    public Parent(ParentId id, string name, DateTime createdAt,
    ...
    /// <summary>
    /// Collection of Parent tags.
    /// </summary>
    [Description("Collection of Parent tags.")]
    ...
    public static Parent Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingParentNameException();
        }

        var parent = new Parent(id, name, DateTime.UtcNow, tags: tags,
        ...
        parent.SetBlockchainMetadata(metadata);
        parent.AddEvent(new ParentCreated(parent));
        return parent;
    }
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new ParentModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new ParentBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidParentTagsException();
        }
    }
}
