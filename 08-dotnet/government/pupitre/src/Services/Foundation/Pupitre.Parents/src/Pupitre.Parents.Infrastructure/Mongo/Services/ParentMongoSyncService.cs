...
using Pupitre.Parents.Infrastructure.Mongo.Options;
using Pupitre.Parents.Infrastructure.Mongo.Repositories;

namespace Pupitre.Parents.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class ParentMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<ParentMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public ParentMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<ParentMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<ParentMongoRepository>();
