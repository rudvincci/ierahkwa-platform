...
internal class CompositeParentRepository : IParentRepository
{
    private readonly ParentPostgresRepository _postgresRepo;
    private readonly ParentMongoRepository _mongoRepo;
    private readonly ParentRedisRepository _redisRepo;
    private readonly ILogger<CompositeParentRepository> _logger;

    public CompositeParentRepository(
        ParentPostgresRepository postgresRepo,
        ParentMongoRepository mongoRepo,
        ParentRedisRepository redisRepo,
        ILogger<CompositeParentRepository> logger)
    {
