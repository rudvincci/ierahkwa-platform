...
namespace Pupitre.GLEs.Infrastructure.EF.Configuration;

public class GLEConfiguration : IEntityTypeConfiguration<GLE>
{
    public GLEConfiguration()
    {
    }

    void IEntityTypeConfiguration<GLE>.Configure(EntityTypeBuilder<GLE> builder)
    {
        builder.ToTable("gle");
        ...
        .HasConversion(c=> c.Value, c=> new GLEId(c))
        .IsRequired();
