...
namespace Pupitre.GLEs.Application.DTO;

internal class GLEDetailsDto : GLEDto
{
    public GLEDetailsDto(
        Guid id,
        string name,
    ...
    public GLEDetailsDto(
        ...
        string? credentialDocumentId = null,
        string? ledgerTransactionId = null)
        : base(gleDto.Id, gleDto.Name, gleDto.Tags,
            gleDto.ProgramCode, gleDto.CredentialType, gleDto.CitizenId,
            gleDto.GovernmentIdentityId, gleDto.BlockchainAccount, gleDto.CredentialStatus,
            gleDto.Nationality, gleDto.BlockchainMetadata)
    {
        CreatedAt = createdAt;
        ModifiedAt = modifiedAt;
        CompletionDate = completionDate;
