...
[assembly: InternalsVisibleTo("Pupitre.GLEs.Tests.Unit.Core.Entities")]
namespace Pupitre.GLEs.Domain.Entities;


internal class GLE : AggregateRoot<GLEId>
{
    #region Fields
    ...
    public GLE(GLEId id, string name, DateTime createdAt,
    ...
    /// <summary>
    /// Collection of GLE tags.
    /// </summary>
    [Description("Collection of GLE tags.")]
    ...
    public static GLE Create(Guid id, string name, IEnumerable<string>? tags,
        string? citizenId = null, string? nationality = null, string? programCode = null,
        string? credentialType = null, DateTime? completionDate = null,
        IDictionary<string, string>? metadata = null)
    {
        ...
        {
            throw new MissingGLENameException();
        }

        var gle = new GLE(id, name, DateTime.UtcNow, tags: tags,
        ...
        gle.SetBlockchainMetadata(metadata);
        gle.AddEvent(new GLECreated(gle));
        return gle;
    }
        ...
        IDictionary<string, string>? metadata = null, string? nationality = null)
    {
        ...
        this.AddEvent(new GLEModified(this));
    }
        ...
        DateTime issuedAt, string? status = "issued")
    {
        ...
        AddEvent(new GLEBlockchainRegistered(Id.Value, identityId, ledgerTransactionId));
    }
    ...
    private static void ValidateTags(IEnumerable<string> tags)
    {
        ...
        {
            throw new InvalidGLETagsException();
        }
    }
}
