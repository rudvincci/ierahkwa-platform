...
using Pupitre.GLEs.Infrastructure.Mongo.Options;
using Pupitre.GLEs.Infrastructure.Mongo.Repositories;

namespace Pupitre.GLEs.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class GLEMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<GLEMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public GLEMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<GLEMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<GLEMongoRepository>();
