...
namespace Pupitre.Notifications.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/notifications")] = Query(typeof(GetNotification).Name),
            [GetKey("POST", "/notifications")] = Command(typeof(AddNotification).Name),
            [GetKey("PUT", "/notifications")] = Command(typeof(UpdateNotification).Name),
            [GetKey("DELETE", "/notifications")] = Command(typeof(DeleteNotification).Name)
        };
