...
internal class CompositeBehaviorRepository : IBehaviorRepository
{
    private readonly BehaviorPostgresRepository _postgresRepo;
    private readonly BehaviorMongoRepository _mongoRepo;
    private readonly BehaviorRedisRepository _redisRepo;
    private readonly ILogger<CompositeBehaviorRepository> _logger;

    public CompositeBehaviorRepository(
        BehaviorPostgresRepository postgresRepo,
        BehaviorMongoRepository mongoRepo,
        BehaviorRedisRepository redisRepo,
        ILogger<CompositeBehaviorRepository> logger)
    {
