...
using Pupitre.AITutors.Infrastructure.Mongo.Options;
using Pupitre.AITutors.Infrastructure.Mongo.Repositories;

namespace Pupitre.AITutors.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class TutorMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<TutorMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public TutorMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<TutorMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<TutorMongoRepository>();
