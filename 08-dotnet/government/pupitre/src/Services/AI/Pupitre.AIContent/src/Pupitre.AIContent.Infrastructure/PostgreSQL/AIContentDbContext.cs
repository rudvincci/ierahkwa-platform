...
namespace Pupitre.AIContent.Infrastructure.PostgreSQL;

internal class AIContentDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<ContentGeneration> ContentGenerations { get; set; }

    public AIContentDbContext(DbContextOptions<AIContentDbContext> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AIContentDbContext).Assembly);
