...
namespace Pupitre.AIContent.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/aicontent")] = Query(typeof(GetContentGeneration).Name),
            [GetKey("POST", "/aicontent")] = Command(typeof(AddContentGeneration).Name),
            [GetKey("PUT", "/aicontent")] = Command(typeof(UpdateContentGeneration).Name),
            [GetKey("DELETE", "/aicontent")] = Command(typeof(DeleteContentGeneration).Name)
        };
