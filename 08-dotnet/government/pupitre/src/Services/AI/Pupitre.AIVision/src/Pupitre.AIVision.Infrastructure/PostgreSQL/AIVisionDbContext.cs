...
namespace Pupitre.AIVision.Infrastructure.PostgreSQL;

internal class AIVisionDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<VisionAnalysis> VisionAnalyses { get; set; }

    public AIVisionDbContext(DbContextOptions<AIVisionDbContext> options) : base(options)
    {
    }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("aivision");
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AIVisionDbContext).Assembly);
