...
using Pupitre.AIVision.Infrastructure.Mongo.Options;
using Pupitre.AIVision.Infrastructure.Mongo.Repositories;

namespace Pupitre.AIVision.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class VisionAnalysisMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<VisionAnalysisMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public VisionAnalysisMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<VisionAnalysisMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<VisionAnalysisMongoRepository>();
