...
internal class VisionAnalysisDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<VisionAnalysis> VisionAnalyses { get; set; }

    public VisionAnalysisDbContext(DbContextOptions<VisionAnalysisDbContext> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(VisionAnalysisDbContext).Assembly);
