...
namespace Pupitre.AIVision.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/aivision")] = Query(typeof(GetVisionAnalysis).Name),
            [GetKey("POST", "/aivision")] = Command(typeof(AddVisionAnalysis).Name),
            [GetKey("PUT", "/aivision")] = Command(typeof(UpdateVisionAnalysis).Name),
            [GetKey("DELETE", "/aivision")] = Command(typeof(DeleteVisionAnalysis).Name)
        };
