...
using Pupitre.AIAdaptive.Infrastructure.Mongo.Options;
using Pupitre.AIAdaptive.Infrastructure.Mongo.Repositories;

namespace Pupitre.AIAdaptive.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class AdaptiveLearningMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AdaptiveLearningMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public AdaptiveLearningMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<AdaptiveLearningMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var postgresRepo = scope.ServiceProvider.GetRequiredService<AdaptiveLearningPostgresRepository>();
        var mongoRepo = scope.ServiceProvider.GetRequiredService<AdaptiveLearningMongoRepository>();
