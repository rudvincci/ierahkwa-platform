...
using Pupitre.AIAdaptive.Infrastructure.Redis.Options;
using Pupitre.AIAdaptive.Infrastructure.Redis.Repositories;

namespace Pupitre.AIAdaptive.Infrastructure.Redis.Services;

internal class AdaptiveLearningRedisSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AdaptiveLearningRedisSyncService> _logger;
    private readonly RedisSyncOptions _options;

    public AdaptiveLearningRedisSyncService(
        IServiceProvider serviceProvider,
        ILogger<AdaptiveLearningRedisSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var redisRepo = scope.ServiceProvider.GetRequiredService<AdaptiveLearningRedisRepository>();
