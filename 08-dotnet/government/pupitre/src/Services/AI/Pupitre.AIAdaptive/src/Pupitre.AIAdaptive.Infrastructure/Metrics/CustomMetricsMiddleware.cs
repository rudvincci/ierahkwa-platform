...
namespace Pupitre.AIAdaptive.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/aiadaptive")] = Query(typeof(GetAdaptiveLearning).Name),
            [GetKey("POST", "/aiadaptive")] = Command(typeof(AddAdaptiveLearning).Name),
            [GetKey("PUT", "/aiadaptive")] = Command(typeof(UpdateAdaptiveLearning).Name),
            [GetKey("DELETE", "/aiadaptive")] = Command(typeof(DeleteAdaptiveLearning).Name)
        };
