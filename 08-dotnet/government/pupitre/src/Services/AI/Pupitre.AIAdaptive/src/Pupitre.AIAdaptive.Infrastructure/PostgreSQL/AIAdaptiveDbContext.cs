...
namespace Pupitre.AIAdaptive.Infrastructure.PostgreSQL;

internal class AIAdaptiveDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<AdaptiveLearning> AdaptiveLearnings { get; set; }

    public AIAdaptiveDbContext(DbContextOptions<AIAdaptiveDbContext> options) : base(options)
    {
    }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("aiadaptive");
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AIAdaptiveDbContext).Assembly);
