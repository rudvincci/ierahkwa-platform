...
internal class AdaptiveLearningDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<AdaptiveLearning> AdaptiveLearnings { get; set; }

    public AdaptiveLearningDbContext(DbContextOptions<AdaptiveLearningDbContext> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AdaptiveLearningDbContext).Assembly);
