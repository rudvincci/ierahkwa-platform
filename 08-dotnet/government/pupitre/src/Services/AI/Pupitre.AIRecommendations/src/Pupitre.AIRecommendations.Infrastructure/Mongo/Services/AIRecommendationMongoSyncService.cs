...
using Pupitre.AIRecommendations.Infrastructure.Mongo.Options;
using Pupitre.AIRecommendations.Infrastructure.Mongo.Repositories;

namespace Pupitre.AIRecommendations.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class AIRecommendationMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AIRecommendationMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public AIRecommendationMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<AIRecommendationMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<AIRecommendationMongoRepository>();
