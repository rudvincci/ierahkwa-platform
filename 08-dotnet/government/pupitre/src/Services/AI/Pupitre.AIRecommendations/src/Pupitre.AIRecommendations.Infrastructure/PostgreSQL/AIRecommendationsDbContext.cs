...
namespace Pupitre.AIRecommendations.Infrastructure.PostgreSQL;

internal class AIRecommendationsDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<AIRecommendation> AIRecommendations { get; set; }

    public AIRecommendationsDbContext(DbContextOptions<AIRecommendationsDbContext> options) : base(options)
    {
    }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("airecommendations");
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AIRecommendationsDbContext).Assembly);
