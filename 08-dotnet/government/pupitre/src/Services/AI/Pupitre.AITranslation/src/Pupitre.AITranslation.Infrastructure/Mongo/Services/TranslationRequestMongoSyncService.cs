...
using Pupitre.AITranslation.Infrastructure.Mongo.Options;
using Pupitre.AITranslation.Infrastructure.Mongo.Repositories;

namespace Pupitre.AITranslation.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class TranslationRequestMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<TranslationRequestMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public TranslationRequestMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<TranslationRequestMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<TranslationRequestMongoRepository>();
