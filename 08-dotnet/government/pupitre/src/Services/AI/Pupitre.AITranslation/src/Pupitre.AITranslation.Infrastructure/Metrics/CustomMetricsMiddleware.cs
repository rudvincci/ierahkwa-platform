...
namespace Pupitre.AITranslation.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/aitranslation")] = Query(typeof(GetTranslationRequest).Name),
            [GetKey("POST", "/aitranslation")] = Command(typeof(AddTranslationRequest).Name),
            [GetKey("PUT", "/aitranslation")] = Command(typeof(UpdateTranslationRequest).Name),
            [GetKey("DELETE", "/aitranslation")] = Command(typeof(DeleteTranslationRequest).Name)
        };
