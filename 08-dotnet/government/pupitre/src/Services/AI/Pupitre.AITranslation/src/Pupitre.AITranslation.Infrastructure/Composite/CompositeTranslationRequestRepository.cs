...
internal class CompositeTranslationRequestRepository : ITranslationRequestRepository
{
    private readonly TranslationRequestPostgresRepository _postgresRepo;
    private readonly TranslationRequestMongoRepository _mongoRepo;
    private readonly TranslationRequestRedisRepository _redisRepo;
    private readonly ILogger<CompositeTranslationRequestRepository> _logger;

    public CompositeTranslationRequestRepository(
        TranslationRequestPostgresRepository postgresRepo,
        TranslationRequestMongoRepository mongoRepo,
        TranslationRequestRedisRepository redisRepo,
        ILogger<CompositeTranslationRequestRepository> logger)
    {
