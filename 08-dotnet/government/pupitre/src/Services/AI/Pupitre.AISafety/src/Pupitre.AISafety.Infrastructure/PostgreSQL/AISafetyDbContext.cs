...
namespace Pupitre.AISafety.Infrastructure.PostgreSQL;

internal class AISafetyDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<SafetyCheck> SafetyChecks { get; set; }

    public AISafetyDbContext(DbContextOptions<AISafetyDbContext> options) : base(options)
    {
    }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("aisafety");
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AISafetyDbContext).Assembly);
