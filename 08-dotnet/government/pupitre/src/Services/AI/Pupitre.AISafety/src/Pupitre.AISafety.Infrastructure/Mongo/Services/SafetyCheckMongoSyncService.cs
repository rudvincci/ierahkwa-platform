...
using Pupitre.AISafety.Infrastructure.Mongo.Options;
using Pupitre.AISafety.Infrastructure.Mongo.Repositories;

namespace Pupitre.AISafety.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class SafetyCheckMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<SafetyCheckMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public SafetyCheckMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<SafetyCheckMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<SafetyCheckMongoRepository>();
