...
internal class SafetyCheckDbContext : DbContext
{
    public DbSet<InboxMessage> Inbox { get; set; }
    public DbSet<OutboxMessage> Outbox { get; set; }
    public DbSet<SafetyCheck> SafetyChecks { get; set; }

    public SafetyCheckDbContext(DbContextOptions<SafetyCheckDbContext> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboxMessage>()
            ...
            .HasConversion<JsonValueConverter<object>>();
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(SafetyCheckDbContext).Assembly);
