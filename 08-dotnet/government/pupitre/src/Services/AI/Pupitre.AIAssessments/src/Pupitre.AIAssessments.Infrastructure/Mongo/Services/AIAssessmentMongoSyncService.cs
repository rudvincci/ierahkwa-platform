...
using Pupitre.AIAssessments.Infrastructure.Mongo.Options;
using Pupitre.AIAssessments.Infrastructure.Mongo.Repositories;

namespace Pupitre.AIAssessments.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class AIAssessmentMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<AIAssessmentMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public AIAssessmentMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<AIAssessmentMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<AIAssessmentMongoRepository>();
