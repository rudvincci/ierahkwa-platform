...
namespace Pupitre.AIAssessments.Infrastructure.Metrics
{
    public class CustomMetricsMiddleware : IMiddleware
    {
        ...
        {
            [GetKey("GET", "/aiassessments")] = Query(typeof(GetAIAssessment).Name),
            [GetKey("POST", "/aiassessments")] = Command(typeof(AddAIAssessment).Name),
            [GetKey("PUT", "/aiassessments")] = Command(typeof(UpdateAIAssessment).Name),
            [GetKey("DELETE", "/aiassessments")] = Command(typeof(DeleteAIAssessment).Name)
        };
