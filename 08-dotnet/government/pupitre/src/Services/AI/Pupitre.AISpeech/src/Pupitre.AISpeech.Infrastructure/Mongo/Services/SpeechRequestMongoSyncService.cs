...
using Pupitre.AISpeech.Infrastructure.Mongo.Options;
using Pupitre.AISpeech.Infrastructure.Mongo.Repositories;

namespace Pupitre.AISpeech.Infrastructure.Mongo.Services;

/// <summary>
/// Background service that syncs data from PostgreSQL to MongoDB.
/// </summary>
internal class SpeechRequestMongoSyncService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<SpeechRequestMongoSyncService> _logger;
    private readonly MongoSyncOptions _options;

    public SpeechRequestMongoSyncService(
        IServiceProvider serviceProvider,
        ILogger<SpeechRequestMongoSyncService> logger,
    ...
    private async Task SyncAsync(CancellationToken cancellationToken)
    {
        ...
        var mongoRepo = scope.ServiceProvider.GetRequiredService<SpeechRequestMongoRepository>();
