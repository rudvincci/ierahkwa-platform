#!/bin/bash
# fix-ai-service.sh - Applies fixes to Mamey-generated AI microservices for Pupitre
# Usage: ./fix-ai-service.sh <SERVICE_NAME> <ENTITY_NAME>

SERVICE_NAME=$1
ENTITY_NAME=$2
BASE_DIR="src/Services/AI/Pupitre.${SERVICE_NAME}/src"
