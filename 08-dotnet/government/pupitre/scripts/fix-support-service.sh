#!/bin/bash
# fix-support-service.sh - Applies fixes to Mamey-generated Support microservices for Pupitre
# Usage: ./fix-support-service.sh <SERVICE_NAME> <ENTITY_NAME>

SERVICE_NAME=$1
ENTITY_NAME=$2
BASE_DIR="src/Services/Support/Pupitre.${SERVICE_NAME}/src"
