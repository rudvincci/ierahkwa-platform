...
namespace MameyNode.Portals.Dex;

// Note: DEX routes are now managed by FutureWampumXRouteService in Areas/FutureWampum/FutureWampumX/
// This service is kept for backward compatibility but routes are delegated to FutureWampumX
public class DexRouteService : IRouteService
{
