...
using Mamey.Government.Modules.Notifications.Core.Clients;
using Mamey.Government.Modules.Notifications.Core.Composite;
...
using Mamey.Government.Modules.Notifications.Core.Mongo;
using Mamey.Government.Modules.Notifications.Core.Services;
using Mamey.Government.Modules.Notifications.Core.Sync;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;

[assembly: InternalsVisibleTo("Mamey.Government.Modules.Notifications.Api")]
namespace Mamey.Government.Modules.Notifications.Core
{
