...
/// <summary>
/// End-to-end tests for PUT /api/identities/{id}/zone endpoint.
/// </summary>
[Collection("EndToEnd")]
public class UpdateZoneEndpointTests : BaseApiEndpointTests
{
    public UpdateZoneEndpointTests(
    ...
    public async Task Put_WithValidCommand_ShouldReturn200Ok()
    {
        ...
        // Act
        var response = await Client.PutAsJsonAsync($"/api/identities/{identityId}/zone", updateCommand);

        // Assert
        response.StatusCode.ShouldBe(HttpStatusCode.OK);
        var content = await response.Content.ReadAsStringAsync();
        content.ShouldContain("Zone updated successfully");

        // Verify zone is updated
        ...
        identity.Zone.ShouldBe("zone-002");
    }
