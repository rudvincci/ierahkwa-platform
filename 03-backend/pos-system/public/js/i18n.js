...
const i18n = {
  ...
  translations: {
    ...
    moh: {
      // Kanien'keha (Mohawk) — Sovereign Indigenous Language
      app_name: 'Ierahkwa POS',
      nav_sale: 'Atennhawiehstani',
      nav_tables: 'Atekhwara',
      nav_orders: 'Kahwatsira',
      nav_reports: 'Tsi Nahotiieriton',
      nav_items: "Oia'ton:a",
      nav_users: "Onkwe'hon:we",
      current_order: 'Nonwa Kahwatsira',
      select_table: 'Satia Atekhwara',
      cart_empty: "Iahte'kanon:ni",
      subtotal: "Tsi Ni'iot",
      tax: 'Tekshenhstakwa',
      discount: 'Iontateriwahtenton',
      total: 'Akwekon',
      clear: 'Satketsko',
      pay: 'Tisahninon',
      all: 'Akwekon',
      search_items: "Kwah oia'ton:a...",
      table_management: 'Tsi Iontatekhwarake',
      add_table: 'Sahseriion Atekhwara',
      available: 'Wahta',
      occupied: 'Ienonhton',
      reserved: 'Iekonnien',
      cleaning: 'Iekohare',
      orders: 'Kahwatsira',
      reports: 'Tsi Nahotiieriton',
      generate: 'Sahri',
      items_management: "Tsi Oia'ton:a",
      add_category: 'Sahseriion Kakhwa',
      add_item: "Sahseriion Oia'ton",
      name: "Ka'shatstenserako:wa",
      category: 'Kakhwa',
      price: "O'non:wa",
      tax_rate: 'Tekshenhstakwa',
      actions: 'Tsi Nahe',
      users_management: "Onkwe'hon:we",
      add_user: "Sahseriion Onkwe'hon:we",
      username: "Ka'shatstenserako:wa",
      full_name: "Akwekon Ka'shatstenserako:wa",
      role: 'Tsi Niionkwarihoten',
      status: 'Tsi Nikanataroten',
      save: 'Satahsontehre',
      cancel: 'Taonsakaton',
      delete: 'Sahkwata',
      edit: 'Sahhrori',
      confirm: 'Tewatonhwentsioni',
      payment: "Tisahninon'a",
      cash: 'Ohwista',
      card: "Kowa'tsi",
      other: 'Oya',
      complete_payment: 'Sahni Tisahninon',
      order_completed: 'Wahni Kahwatsira',
      print_receipt: 'Sahiatonhkwe Wahsonterakwa',
      new_order: 'Ase Kahwatsira',
      daily_summary: 'Wennisera Tsi Nahe',
      total_orders: 'Akwekon Kahwatsira',
      total_revenue: 'Akwekon Ohwista',
      avg_order: 'Tsi Niiot',
      top_items: "Onhka Ieienteristha",
      sales_by_hour: 'Atennhawiehstani Iorhenhne',
      admin: 'Roia:ner',
      cashier: 'Ohwistahkwa',
      manager: 'Raiatakweniio',
      active: 'Iekonnien',
      inactive: 'Iahte Iekonnien',
      password: 'Ienoronhkwa',
      permissions: 'Tsi Nahoten Iekonnien',
      language: "Owenna'shon:a",
      logout: 'Satia',
      login: 'Kasenne',
      welcome: 'Kwe',
      table: 'Atekhwara',
      capacity: "Tsi Ni'iot Ienonhton",
      floor: 'Ohnakara',
      position: 'Tsi Ithre',
      shape: 'Tsi Nahotiieriton',
      rectangle: 'Kaieri Nikawera',
      circle: "Otsitsia'ton",
      order_number: 'Kahwatsira #',
      date: 'Wennisera',
      time: 'Iorhenhne',
      customer: 'Atennitenron',
      notes: 'Tahatiientane',
      quantity: 'Tsi Niiot',
      unit_price: "O'non:wa Enskat",
      item_total: "Akwekon Oia'ton",
      payment_method: 'Tsi Nahe Tisahninon',
      change: 'Onkwe',
      amount_paid: 'Ohwista Wahni',
      pending: 'Rotiienta',
      completed: 'Wahni',
      cancelled: 'Tontahontkahrho'
    }
  },
