# SDK Soberano — Kit de Desarrollo Completo para Naciones Digitales

> SDK completo que reemplaza Microsoft .NET SDK y Visual Studio. CLI soberano, templates para 19 tipos de proyecto, package manager WAMPUM, linter y formatter integrados, generador d

## Resumen

**SDK Soberano** es una plataforma del ecosistema **Ierahkwa Ne Kanienke**, parte de **NEXUS Forja (Desarrollo & DevOps)**. Diseñada para la soberanía digital de más de mil millones de personas en las Américas en 35+ países y 574 tribus.
...
cd 02-plataformas-html/sdk-soberano
