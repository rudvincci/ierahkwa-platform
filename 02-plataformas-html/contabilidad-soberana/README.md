# Contabilidad Soberana — Sistema Contable Nacional

> Sistema de contabilidad de partida doble con plan de cuentas soberano, multi-moneda WAMPUM, cumplimiento NIIF/IFRS adaptado y generación automática de estados f

## Resumen

**Contabilidad Soberana** es una plataforma del ecosistema **Ierahkwa Ne Kanienke**, parte de **NEXUS Forja (Desarrollo & DevOps)**. Diseñada para la soberanía digital de más de mil millones de personas en las Américas en 35+ países y 574 tribus.
...
7. **Planes Soberanos**
8. **📊**
9. **Profesional 19 W/mes**
10. **Gobierno 99 W/mes**
...
cd 02-plataformas-html/contabilidad-soberana
