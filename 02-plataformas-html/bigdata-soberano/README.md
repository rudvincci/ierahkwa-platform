# Big Data Soberano — Procesamiento Masivo de Datos para Soberanía Digital

> Framework de procesamiento masivo que reemplaza Apache Hadoop, Spark y Flink. Motor MapReduce soberano en Rust, procesamiento en memoria distribuido, pipeline E

## Resumen

**Big Data Soberano** es una plataforma del ecosistema **Ierahkwa Ne Kanienke**, parte de **NEXUS Forja (Desarrollo & DevOps)**. Diseñada para la soberanía digital de más de mil millones de personas en las Américas en 35+ países y 574 tribus.
...
cd 02-plataformas-html/bigdata-soberano
