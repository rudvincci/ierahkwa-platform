# Transporte Público — Sistema de Transporte Público

> Transporte Público — plataforma soberana de grado empresarial para las 35+ países del ecosistema Ierahkwa Ne Kanienke. Sistema de Transporte Público con cifrad

## Resumen

**Transporte Público** es una plataforma del ecosistema **Ierahkwa Ne Kanienke**, parte de **NEXUS Urbe (Ciudad Inteligente)**. Diseñada para la soberanía digital de más de mil millones de personas en las Américas en 35+ países y 574 tribus.
...
cd 02-plataformas-html/transporte-publico-soberano
...
Esta plataforma pertenece a **NEXUS Urbe (Ciudad Inteligente)** del ecosistema Ierahkwa.
