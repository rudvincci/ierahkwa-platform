# Microservicios Soberano — Framework de Microservicios Event-Driven Soberano

> Framework de microservicios que reemplaza .NET Aspire y Dapr. Orquestación con contenedores soberanos (no Docker/Kubernetes), service mesh nativo, event sourcing con CQRS, saga pat

## Resumen

**Microservicios Soberano** es una plataforma del ecosistema **Ierahkwa Ne Kanienke**, parte de **NEXUS Forja (Desarrollo & DevOps)**. Diseñada para la soberanía digital de más de mil millones de personas en las Américas en 35+ países y 574 tribus.
...
cd 02-plataformas-html/microservicios-soberano
